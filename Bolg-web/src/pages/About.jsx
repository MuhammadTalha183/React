    ...
    >
      ...
      >
        <Chip
          ...
          label="Full-Stack Developer & Data Science Student"
          sx={{
            mb: 2.5,
            px: 2,
            py: 2.2,
        ...
        >
          Welcome! I'm a developer specializing in full-stack web application development
          (React, Express, Node.js, MongoDB, Tailwind CSS) alongside exploratory data analysis
          and machine learning architectures in Python. Currently working on smart system integrations
      ...
      <Box sx={{ mb: 12 }}>
        ...
        <Grid container spacing={3}>
          {[
            {
              icon: <Code2 size={28} color="#4f46e5" />,
              title: "Full-Stack Development",
              desc: "Building dynamic React applications paired with robust Node.js/Express REST APIs and clean Tailwind/MUI interfaces."
            },
            {
              icon: <Database size={28} color="#7c3aed" />,
              title: "Databases & Architecture",
              desc: "Engineering relational schema models in PostgreSQL and MySQL alongside MongoDB document stores."
            },
            {
              icon: <Terminal size={28} color="#ec4899" />,
              title: "Data Analysis & ML",
              desc: "Performing exploratory data analysis with Pandas, Matplotlib, and Seaborn, as well as computer vision neural network workflows."
            },
            {
              icon: <Cpu size={28} color="#10b981" />,
              title: "Networks & Security",
              desc: "Exploring core computer networking protocols, software risk analysis, and information security principles."
            }
          ].map((val, idx) => (
            <Grid
              item
      ...
      <Box sx={{ mb: 10 }}>
        ...
        >
          The strategists, designers, and engineers maintaining NexusInk's publishing standards.
        </Typography>
      ...
      >
        ...
        >
          Join thousands of creators who publish deep, inspiring stories on NexusInk every single day.
        </Typography>
